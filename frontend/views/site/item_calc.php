                                                ...
                                                foreach($row->specificallies as $low):?>
                                                        ...
                                                        <div class="radio">
                                                            <label class="custom-radio-wrapper">
                                                                <span class="custom-radio-container">
                                                                    <input type="radio" name="1" value="<?=$low->extra->markup?>" checked>
                                                    ...
                                                    <?}else{?>
                                                        <div class="radio disabled">
                                                            <label class="custom-radio-wrapper">
                                                                <span class="custom-radio-container">
                                                                    <input type="radio" name="2" value="<?=$low->extra->markup?>" disabled>
                                                                    <span class="custom-radio-icon"></span>
                                                                </span>
                                                                <span><?=$low->specialty?></span>
                                                            </label>
                                                ...
                                                foreach($row->specificallies as $low):?>
                                                    <div class="checkbox">
                                                        ...
                                                        <span class="custom-checkbox-container">
                                                            <input type="checkbox" name="<?=$low['id'].'_'.$low['title']?>" value="<?=Common::getMarkup($model,$low->extra->markup)['newPrice']?>" OnChange="volume.search(this)">
