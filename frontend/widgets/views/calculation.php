...
?>
    ...
    <?php if (Yii::$app->session->hasFlash('calculationMessage'))
    {
    ...
    }else
    {
        ...
        <div class="row calc-section">
            <div class="col-md-6">
            <?= $form->field($model, 'place')->textInput(['placeholder' => 'Укажите место строительства','class'=>'form-control no-radius']) ->label(false);?>
            <?= $form->field($model, 'width')->textInput(['placeholder' => 'Ширина постройки','class'=>'form-control no-radius']) ->label(false);?>
            <?= $form->field($model, 'length')->textInput(['placeholder' => 'Длина постройки','class'=>'form-control no-radius']) ->label(false);?>
            </div>
            <div class="col-md-6">
                <?php $items = [
        ...
        <div class="row calc-section">
            ...
            <div class="col-md-3 sky-form">
                ...
                <?= $form->field($model, 'bathhouse')->checkbox([
                    'label' => '<i></i>Баня',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'pavilion')->checkbox([
                    'label' => '<i></i>Беседка',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'well')->checkbox([
                    'label' => '<i></i>Колодец',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
            ...
            <div class="col-md-3 sky-form">
                <?= $form->field($model, 'hangar')->checkbox([
                    'label' => '<i></i>Сарай',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'boiler_room')->checkbox([
                    'label' => '<i></i>Котельная',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'chopped_terrace')->checkbox([
                    'label' => '<i></i>Рубленная терраса',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'porch')->checkbox([
                    'label' => '<i></i>Крыльцо',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
            ...
            <div class="col-md-3 sky-form">
                ...
                <?= $form->field($model, 'chopped_gables')->checkbox([
                    'label' => '<i></i>Рубленые фронтоны',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'fifth_wall')->checkbox([
            ...
            <div class="col-md-3 sky-form">
                <?= $form->field($model, 'second_light')->checkbox([
                    'label' => '<i></i>Второй свет',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'prostrozhka_plane')->checkbox([
                    'label' => '<i></i>Обработка рубанком',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'antiseptic')->checkbox([
                    'label' => '<i></i>Обр-ка антисептиком',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
                ]);?>
                <?= $form->field($model, 'sixth_wall')->checkbox([
        ...
        <div class="row calc-section">
            ...
            <div class="col-md-4 sky-form">
                <?= $form->field($model, 'light')->checkbox([
                    'label' => '<i></i>Свет',
                    'labelOptions' => [
                        'class' => 'checkbox'
                    ],
            ...
            <div class="col-md-4 sky-form">
                <?= $form->field($model, 'cabins')->checkbox([
            ...
            <div class="col-md-4 sky-form">
                <?= $form->field($model, 'nothing')->checkbox([
        ...
        <div class="row calc-section">
            <div class="col-md-6">
                    <?= $form->field($model, 'name')->textInput(['placeholder' => 'Ваше имя','class'=>'form-control no-radius'])->label(false) ;?>
                    <?= $form->field($model, 'email')->textInput(['placeholder' => 'Ваш E-mail','class'=>'form-control no-radius'])->label(false) ;?>
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'body')->textarea(['placeholder' => 'Комментарий к заявке на расчет стоимости', 'rows' => 7,'class'=>'form-control no-radius'])->label(false) ;?>
            </div>
        </div>
        ...
        <div class="sky-form"><?= $form->field($model, 'agreement')->checkbox([
