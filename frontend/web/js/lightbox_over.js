...
ImageBox.prototype.show_overlay = function (n) {
    ...
    if(!this.box_overlay){
        ...
        div_img.classList.add('box-image','image-active');
...
ImageBox.prototype.close_overlay = function (){
    ...
    this.box_overlay.style.display = 'none';
    this.stop_scroll(0);
};
ImageBox.prototype.lightbox_size = function (box) {
    var image = box.querySelector('.image-active');
